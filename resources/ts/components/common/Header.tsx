...
import { BookOpenIcon, CircleUserRound, HomeIcon, ListCollapse, MailIcon, TagIcon } from "lucide-react";
      ...
      <div className="flex items-center gap-2">
        ...
        {auth && (
          <>
            ...
            <Link href={route('admin.series.index')} className="text-gray-300 hover:text-gray-500 transition-colors duration-200 p-2" title="Quản lý series">
        ...
        {!auth ? (
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost">{auth.name}</Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent className="w-56 bg-gray-900" align="start">
              <DropdownMenuItem onClick={() => router.get(route('logout'))} className="text-gray-300 hover:cursor-pointer hover:bg-slate-100">
                Đăng xuất
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
